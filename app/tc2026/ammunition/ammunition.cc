...
void Ammunition::ammunition_reset_str_arithm(char *str, char *s, char *d, char *e, char *g) {
    int i;
    for (i = 0; i < 20; i++) {
        str[i] = 0;
        s[i] = 0;
...
int Ammunition::ammunition_bits_test() {
    char str[8];
    char str1[8];
    ...
    for (i = 0; i < sizeof(str) * CHAR_BIT; i++)
        if (!ammunition_is_zero_bit_string(str, i, (sizeof(str) * CHAR_BIT - i) / 2 + 1)) result = 1;
    ammunition_bit_string_set(str, 13, 1, 35);
    for (i = 0; i < 13; i++)
        if (!ammunition_is_zero_bit_string(str, i, 13 - i)) result = 1;
    for (i = 13; i < 48; i++)
        if (ammunition_is_zero_bit_string(str, i, 48 - i)) result = 1;
    for (i = 48; i < sizeof(str) * CHAR_BIT; i++)
        if (!ammunition_is_zero_bit_string(str, i, sizeof(str) * CHAR_BIT - i)) result = 1;
    ...
    for (i = 0; i + i / 2 + 1 < sizeof(str) * CHAR_BIT; i++) {
        ...
        if (!ammunition_is_zero_bit_string(str, 0, i - 1)) result = 1;
        if (ammunition_is_zero_bit_string(str, i, i / 2 + 1)) result = 1;
        if (!ammunition_is_zero_bit_string(str, i + i / 2 + 1, sizeof(str) * CHAR_BIT - (i + i / 2 + 1))) result = 1;
    ...
    for (i = 0; i < 42; i++)
        if (ammunition_bit_string_comparison(str, i, str1, i, 42 - i) != 0) result = 1;
    for (i = 0; i < 43; i++)
        if (ammunition_bit_string_comparison(str, i, str1, i, sizeof(str) * CHAR_BIT - i) <= 0) result = 1;
    for (i = 0; i < 43; i++)
        if (ammunition_bit_string_comparison(str1, i, str, i, sizeof(str) * CHAR_BIT - i) >= 0) result = 1;
    ...
    for (i = 0; i + 5 < sizeof(str) * CHAR_BIT; i++) {
        ...
        if (ammunition_bit_string_comparison(str1, i + 5, str, i, sizeof(str) * CHAR_BIT - i - 5) != 0) result = 1;
    }
    ...
    for (i = 0; i + 5 < sizeof(str) * CHAR_BIT; i++) {
        ...
        if (ammunition_bit_string_comparison(str, i + 5, str1, i, sizeof(str) * CHAR_BIT - i - 5) != 0) result = 1;
    }
    ...
    for (i = 0; i + 5 < sizeof(str) * CHAR_BIT; i++) {
        ...
        if (ammunition_bit_string_comparison(str, i, str1, i + 5, sizeof(str) * CHAR_BIT - i - 5) != 0) result = 1;
    }

    return result;
}

int Ammunition::ammunition_arithm_test() {
    int result = 0;
    ...
    for (i = -2000; i < 2000; i++) {
        ...
        if (ammunition_overflow_bit) result = 1;
        ammunition_integer_to_string(4, d, s);
        if (ammunition_atoi(s) != i + i + 1) result = 1;
    }
    ...
    for (i = -2000; i < 2000; i++) {
        ...
        if (ammunition_overflow_bit) result = 1;
        ammunition_integer_to_string(4, d, s);
        if (ammunition_atoi(s) != i + i - 10) result = 1;
    }
    ...
    if (ammunition_overflow_bit) result = 1;
    ammunition_unsigned_integer_to_string(4, d, s);
    if (ammunition_strcmp(s, "0") != 0) result = 1;
    for (i = 0; i < 4000; i++) {
        ammunition_sprintf_u(str, i);
        ammunition_unsigned_integer_from_string(4, str, d);
        ...
        if (ammunition_overflow_bit) result = 1;
        ammunition_unsigned_integer_to_string(4, d, s);
        if (ammunition_atoi(s) != i - i / 2) result = 1;
    }
    ...
    for (i = -2000; i < 2000; i++) {
        ...
        if (ammunition_overflow_bit) result = 1;
        ammunition_integer_to_string(4, d, s);
        if (ammunition_atoi(s) != i * (i + 1000)) result = 1;
    }
    ...
    for (i = -2000; i < 2000; i++) {
        ...
        if (ammunition_overflow_bit) result = 1;
        ammunition_integer_to_string(4, d, s);
        if (ammunition_atoi(s) != i / (i < 0 ? -i / 20 + 1 : -i / 20 - 1)) result = 1;
        ammunition_sprintf_d(str, i);
        ammunition_integer_from_string(4, str, d);
    ...
    for (i = 0; i < 4000; i++) {
        ...
        if (ammunition_overflow_bit) result = 1;
        ammunition_unsigned_integer_to_string(4, d, s);
        if (ammunition_atoi(s) != i / (i / 20 + 1)) result = 1;
    }
    ...
    ammunition_unsigned_integer_to_string(4, d, s);
    if (ammunition_overflow_bit || ammunition_strcmp(s, "1348") != 0) result = 1;
    ammunition_unsigned_integer_from_string(4, "1348", d);
    ammunition_unsigned_integer_shift_right(4, d, 32, d);
    ammunition_unsigned_integer_to_string(4, d, s);
    if (!ammunition_overflow_bit || ammunition_strcmp(s, "0") != 0) result = 1;
    ammunition_unsigned_integer_from_string(4, "1348", d);
    ammunition_unsigned_integer_shift_right(4, d, 8, d);
    ammunition_unsigned_integer_to_string(4, d, s);
    if (!ammunition_overflow_bit || ammunition_strcmp(s, "5") != 0) result = 1;
    ammunition_unsigned_integer_from_string(4, "134890", d);
    ammunition_unsigned_integer_shift_right(4, d, 13, d);
    ammunition_unsigned_integer_to_string(4, d, s);
    if (!ammunition_overflow_bit || ammunition_strcmp(s, "16") != 0) result = 1;
    ammunition_unsigned_integer_from_string(4, "134890", d);
    ...
    ammunition_integer_shift_right(4, d, 32, d);
    ammunition_integer_to_string(4, d, s);
    if (!ammunition_overflow_bit || ammunition_strcmp(s, "-1") != 0) result = 1;
    ammunition_integer_from_string(4, "-1348", d);
    ammunition_integer_shift_right(4, d, 8, d);
    ammunition_integer_to_string(4, d, s);
    if (!ammunition_overflow_bit || ammunition_strcmp(s, "-6") != 0) result = 1;
    ammunition_integer_from_string(4, "-134890", d);
    ammunition_integer_shift_right(4, d, 13, d);
    ammunition_integer_to_string(4, d, s);
    if (!ammunition_overflow_bit || ammunition_strcmp(s, "-17") != 0) result = 1;
    ammunition_integer_from_string(4, "-134890", d);
    ammunition_integer_shift_left(4, d, -13, d);
    ammunition_integer_to_string(4, d, s);
    if (!ammunition_overflow_bit || ammunition_strcmp(s, "-17") != 0) result = 1;
    ...
    ammunition_unsigned_integer_to_string(4, d, s);
    if (ammunition_overflow_bit || ammunition_strcmp(s, "345088") != 0) result = 1;
    ammunition_unsigned_integer_from_string(4, "134890", d);
    ammunition_unsigned_integer_shift_left(4, d, 13, d);
    ammunition_unsigned_integer_to_string(4, d, s);
    if (ammunition_overflow_bit || ammunition_strcmp(s, "1105018880") != 0) result = 1;
    ammunition_unsigned_integer_from_string(4, "134890", d);
    ammunition_unsigned_integer_shift_right(4, d, -13, d);
    ammunition_unsigned_integer_to_string(4, d, s);
    if (ammunition_overflow_bit || ammunition_strcmp(s, "1105018880") != 0) result = 1;
    ...
    if (ammunition_eq_integer(4, d, e)) result = 1;
    ammunition_integer_from_string(4, "-1348", d);
    ammunition_integer_from_string(4, "-1348", e);
    if (!ammunition_eq_integer(4, d, e)) result = 1;
    ...
    if (ammunition_eq_unsigned_integer(4, d, e)) result = 1;
    ammunition_unsigned_integer_from_string(4, "1348", d);
    ammunition_unsigned_integer_from_string(4, "1348", e);
    if (!ammunition_eq_unsigned_integer(4, d, e)) result = 1;
    ...
    ammunition_integer_from_string(4, "-10", d);
    ammunition_integer_from_string(4, "1348", e);
    if (!ammunition_ne_integer(4, d, e)) result = 1;
    ammunition_integer_from_string(4, "-1348", d);
    ammunition_integer_from_string(4, "-1348", e);
    if (ammunition_ne_integer(4, d, e)) result = 1;
    ...
    ammunition_unsigned_integer_from_string(4, "10", d);
    ammunition_unsigned_integer_from_string(4, "1348", e);
    if (!ammunition_ne_unsigned_integer(4, d, e)) result = 1;
    ammunition_unsigned_integer_from_string(4, "1348", d);
    ammunition_unsigned_integer_from_string(4, "1348", e);
    if (ammunition_ne_unsigned_integer(4, d, e)) result = 1;
    ...
    ammunition_integer_from_string(4, "-10", d);
    ammunition_integer_from_string(4, "1348", e);
    if (ammunition_gt_integer(4, d, e)) result = 1;
    ammunition_integer_from_string(4, "-1348", d);
    ammunition_integer_from_string(4, "-1348", e);
    if (ammunition_gt_integer(4, d, e)) result = 1;
    ...
    ammunition_unsigned_integer_from_string(4, "10", d);
    ammunition_unsigned_integer_from_string(4, "1348", e);
    if (ammunition_gt_unsigned_integer(4, d, e)) result = 1;
    ammunition_unsigned_integer_from_string(4, "1348", d);
    ammunition_unsigned_integer_from_string(4, "1348", e);
    if (ammunition_gt_unsigned_integer(4, d, e)) result = 1;
    ...
    ammunition_integer_from_string(4, "-10", d);
    ammunition_integer_from_string(4, "1348", e);
    if (!ammunition_lt_integer(4, d, e)) result = 1;
    ammunition_integer_from_string(4, "-1348", d);
    ammunition_integer_from_string(4, "-1348", e);
    if (ammunition_lt_integer(4, d, e)) result = 1;
    ammunition_integer_from_string(4, "-1000000", d);
    ...
    ammunition_unsigned_integer_from_string(4, "10", d);
    ammunition_unsigned_integer_from_string(4, "1348", e);
    if (!ammunition_lt_unsigned_integer(4, d, e)) result = 1;
    ammunition_unsigned_integer_from_string(4, "1348", d);
    ammunition_unsigned_integer_from_string(4, "1348", e);
    if (ammunition_lt_unsigned_integer(4, d, e)) result = 1;
    ammunition_unsigned_integer_from_string(4, "1000000", d);
    ...
    ammunition_integer_from_string(4, "-10", d);
    ammunition_integer_from_string(4, "1348", e);
    if (ammunition_ge_integer(4, d, e)) result = 1;
    ammunition_integer_from_string(4, "-1348", d);
    ammunition_integer_from_string(4, "-1348", e);
    if (!ammunition_ge_integer(4, d, e)) result = 1;
    ammunition_integer_from_string(4, "-1000000", d);
    ...
    ammunition_unsigned_integer_from_string(4, "10", d);
    ammunition_unsigned_integer_from_string(4, "1348", e);
    if (ammunition_ge_unsigned_integer(4, d, e)) result = 1;
    ammunition_unsigned_integer_from_string(4, "1348", d);
    ammunition_unsigned_integer_from_string(4, "1348", e);
    if (!ammunition_ge_unsigned_integer(4, d, e)) result = 1;
    ammunition_unsigned_integer_from_string(4, "1000000", d);
    ...
    ammunition_integer_from_string(4, "-10", d);
    ammunition_integer_from_string(4, "1348", e);
    if (!ammunition_le_integer(4, d, e)) result = 1;
    ammunition_integer_from_string(4, "-1348", d);
    ammunition_integer_from_string(4, "-1348", e);
    if (!ammunition_le_integer(4, d, e)) result = 1;
    ammunition_integer_from_string(4, "-1000000", d);
    ...
    ammunition_unsigned_integer_from_string(4, "10", d);
    ammunition_unsigned_integer_from_string(4, "1348", e);
    if (!ammunition_le_unsigned_integer(4, d, e)) result = 1;
    ammunition_unsigned_integer_from_string(4, "1348", d);
    ammunition_unsigned_integer_from_string(4, "1348", e);
    if (!ammunition_le_unsigned_integer(4, d, e)) result = 1;
    ammunition_unsigned_integer_from_string(4, "1000000", d);
    ...
    if (ammunition_overflow_bit || ammunition_strcmp(s, "30000") != 0) result = 1;
    ...
    if (ammunition_overflow_bit || ammunition_strcmp(s, "11230000") != 0) result = 1;
    ...
    if (ammunition_strcmp(s, "1348") != 0) result = 1;
    ammunition_unsigned_integer_from_string(4, "1348", d);
    ammunition_unsigned_integer_from_string(4, "0", e);
    ammunition_unsigned_integer_or(4, d, e, e);
    ammunition_unsigned_integer_to_string(4, e, s);
    ...
    ammunition_unsigned_integer_or(4, d, e, e);
    ammunition_unsigned_integer_to_string(4, e, s);
    if (ammunition_strcmp(s, "4294967295") != 0) result = 1;
    ammunition_unsigned_integer_from_string(4, "1348", d);
    ammunition_unsigned_integer_from_string(4, "96", e);
    ammunition_unsigned_integer_or(4, d, e, e);
    ammunition_unsigned_integer_to_string(4, e, s);
    if (ammunition_strcmp(s, "1380") != 0) result = 1;
    ...
    ammunition_integer_or(4, d, e, e);
    ammunition_integer_to_string(4, e, s);
    if (ammunition_strcmp(s, "-1") != 0) result = 1;
    ammunition_integer_from_string(4, "1348", d);
    ...
    ammunition_unsigned_integer_and(4, d, e, e);
    ammunition_unsigned_integer_to_string(4, e, s);
    if (ammunition_strcmp(s, "64") != 0) result = 1;
    ...
    ammunition_unsigned_integer_to_string(4, d, s);
    if (ammunition_strcmp(s, "4294965947") != 0) result = 1;
    ...
    ammunition_integer_to_string(4, d, s);
    if (ammunition_strcmp(s, "-1349") != 0) result = 1;
