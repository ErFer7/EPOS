...
static float x[KF_DIM];          // State vector
static float P[KF_DIM][KF_DIM];  // Covariance matrix
static float F[KF_DIM][KF_DIM];  // State transition matrix
static float Q[KF_DIM][KF_DIM];  // Process noise covariance
static float H[KF_DIM][KF_DIM];  // Observation matrix
static float R[KF_DIM][KF_DIM];  // Measurement noise covariance
static float z[KF_DIM];          // Measurement vector

static float temp_NxN_1[KF_DIM][KF_DIM];
static float temp_NxN_2[KF_DIM][KF_DIM];
static float temp_NxN_3[KF_DIM][KF_DIM];
static float temp_N[KF_DIM];
static float K[KF_DIM][KF_DIM];
