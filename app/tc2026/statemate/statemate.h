...
class Statemate {
   public:
    ...
    inline int run() {
        ...
        int index;
        for (index = 63; index >= 0; index--) checksum += (unsigned long)(statemate_bitlist[index]) << index;
   ...
   private:
    void statemate_interface(void) {
        ...
        if (SYS_bit_get(statemate_bitlist, entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL_IDX) ||
            ...
            statemate_tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRLexited_BEREIT_FH_TUERMODUL_CTRL = statemate_time;
        ...
        if ((SYS_bit_get(statemate_bitlist, entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRL_IDX) ||
    ...
    */
        ...
        if (SYS_bit_get(statemate_bitlist, active_KINDERSICHERUNG_CTRL_IDX)) {
            switch (statemate_KINDERSICHERUNG_CTRL_KINDERSICHERUNG_CTRL_next_state) {
                case 1: { /** state ZENTRAL in chart KINDERSICHERUNG_CTRL **/
                    if (!(statemate_FH_TUERMODUL__SFHA_ZENTRAL || statemate_FH_TUERMODUL__SFHZ_ZENTRAL)) {
                        statemate_stable = 0;
                    ...
                    switch (statemate_ZENTRAL_KINDERSICHERUNG_CTRL_next_state) {
                        case 1: { /** state IN_ZENTRAL in chart KINDERSICHERUNG_CTRL **/
                            if ((statemate_FH_TUERMODUL__SFHA_ZENTRAL && !(statemate_FH_TUERMODUL__SFHA_ZENTRAL_old))) {
                                statemate_stable = 0;
                            ...
                            if ((statemate_FH_TUERMODUL__SFHZ_ZENTRAL && !(statemate_FH_TUERMODUL__SFHZ_ZENTRAL_old))) {
                                statemate_stable = 0;
                ...
                case 2: { /** state MEC in chart KINDERSICHERUNG_CTRL **/
                    if (!(statemate_FH_TUERMODUL__SFHA_MEC || statemate_FH_TUERMODUL__SFHZ_MEC)) {
                        statemate_stable = 0;
                        statemate_FH_TUERMODUL__SFHZ_copy = 0;
                        statemate_FH_TUERMODUL__SFHA_copy = 0;
                    ...
                    switch (statemate_MEC_KINDERSICHERUNG_CTRL_next_state) {
                        case 1: { /** state INMEC in chart KINDERSICHERUNG_CTRL **/
                            if ((statemate_FH_TUERMODUL__SFHA_MEC && !(statemate_FH_TUERMODUL__SFHA_MEC_old))) {
                                statemate_stable = 0;
                                statemate_FH_TUERMODUL__SFHA_copy = 1;
                            ...
                            if ((statemate_FH_TUERMODUL__SFHZ_MEC && !(statemate_FH_TUERMODUL__SFHZ_MEC_old))) {
                                statemate_stable = 0;
                                statemate_FH_TUERMODUL__SFHZ_copy = 1;
                ...
                case 3: { /** state WAITING in chart KINDERSICHERUNG_CTRL **/
                    if ((!statemate_FH_TUERMODUL__KL_50) &&
                        (statemate_FH_TUERMODUL__SFHZ_MEC && statemate_FH_TUERMODUL__SFHA_MEC)) {
                        statemate_stable = 0;
                        statemate_FH_TUERMODUL__SFHZ_copy = 1;
                        statemate_FH_TUERMODUL__SFHA_copy = 1;
                    ...
                    if ((!statemate_FH_TUERMODUL__SFHZ_ZENTRAL && statemate_FH_TUERMODUL__SFHA_ZENTRAL &&
    ...
    void statemate_generic_FH_TUERMODUL_CTRL(void) {
        ...
        if (SYS_bit_get(statemate_bitlist, active_FH_TUERMODUL_CTRL_IDX)) {
            ...
            if (!SYS_bit_get(statemate_bitlist, active_BLOCK_ERKENNUNG_CTRL_IDX)) {
                SYS_bit_clr(statemate_bitlist, entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRL_IDX);
            ...
            switch (statemate_B_FH_TUERMODUL_CTRL_next_state) {
                case 1: { /** state ZAEHLER_WHSP_ZU_HOCH in chart FH_TUERMODUL_CTRL **/
                    if ((statemate_FH_TUERMODUL_CTRL__N == 59 && !(statemate_FH_TUERMODUL_CTRL__N_old == 59))) {
                        statemate_stable = 0;
                ...
                case 2: { /** state NICHT_INITIALISIERT in chart FH_TUERMODUL_CTRL **/
                    if (((statemate_FH_TUERMODUL__BLOCK && !(statemate_FH_TUERMODUL__BLOCK_old))) &&
                ...
                case 3: { /** state INITIALISIERT in chart FH_TUERMODUL_CTRL **/
                    if (((statemate_FH_TUERMODUL_CTRL__N > 60 && !(statemate_FH_TUERMODUL_CTRL__N_old > 60))) &&
                        ((!(statemate_FH_TUERMODUL_CTRL__INREVERS1 || statemate_FH_TUERMODUL_CTRL__INREVERS2)))) {
                        statemate_stable = 0;
                        statemate_FH_TUERMODUL__MFHZ_copy = 0;
                        statemate_FH_TUERMODUL__MFHA_copy = 0;
                        ...
                        case 1: { /** state OEFFNEN in chart FH_TUERMODUL_CTRL **/
                            ...
                            switch (statemate_OEFFNEN_FH_TUERMODUL_CTRL_next_state) {
                                case 1: { /** state TIPP_OEFFNEN in chart FH_TUERMODUL_CTRL **/
                                    if ((statemate_FH_TUERMODUL__SFHZ && !(statemate_FH_TUERMODUL__SFHZ_old)) ||
                                ...
                                case 2: { /** state MAN_OEFFNEN in chart FH_TUERMODUL_CTRL **/
                                    ...
                                    if ((!(statemate_FH_TUERMODUL__SFHA) && statemate_FH_TUERMODUL__SFHA_old)) {
                                        statemate_stable = 0;
                                        statemate_FH_TUERMODUL__MFHA_copy = 0;
            ...
            switch (statemate_A_FH_TUERMODUL_CTRL_next_state) {
                case 1: { /** state WIEDERHOLSPERRE in chart FH_TUERMODUL_CTRL **/
                    SYS_bit_clr(statemate_bitlist, entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL_copy_IDX);
                    if ((statemate_step == 1 &&
                         statemate_tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRLexited_BEREIT_FH_TUERMODUL_CTRL != 0 &&
                         (statemate_time -
                        ...
                        SYS_bit_set(statemate_bitlist, entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL_copy_IDX);
                    ...
                    switch (statemate_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL_next_state) {
                        case 1: { /** state WDHSP in chart FH_TUERMODUL_CTRL **/
                            if ((statemate_step == 1 && statemate_tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL != 0 &&
                                 (statemate_time - statemate_tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL == 3)) &&
                                (((!(statemate_FH_TUERMODUL__MFHZ || statemate_FH_TUERMODUL__MFHA)) &&
            ...
            switch (statemate_EINKLEMMSCHUTZ_CTRL_EINKLEMMSCHUTZ_CTRL_next_state) {
                case 1: { /** state NORMALBETRIEB in chart EINKLEMMSCHUTZ_CTRL **/
                    if (((statemate_FH_TUERMODUL__EKS_LEISTE_AKTIV &&
                        ...
                        ((!(statemate_FH_TUERMODUL__SFHZ && statemate_FH_TUERMODUL__SFHA)))) {
                        statemate_stable = 0;
                ...
                case 2: { /** state EINKLEMMUNG in chart EINKLEMMSCHUTZ_CTRL **/
                    ...
                    if ((!(statemate_FH_TUERMODUL__EKS_LEISTE_AKTIV) && statemate_FH_TUERMODUL__EKS_LEISTE_AKTIV_old)) {
                        statemate_stable = 0;
            ...
            switch (statemate_BLOCK_ERKENNUNG_CTRL_BLOCK_ERKENNUNG_CTRL_next_state) {
                case 1: { /** state KEINE_BEWEGUNG in chart BLOCK_ERKENNUNG_CTRL **/
                    if ((statemate_FH_TUERMODUL__I_EIN != statemate_FH_TUERMODUL__I_EIN_old) &&
                        ...
                        SYS_bit_set(statemate_bitlist, entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRL_IDX);
                        break;
                    }
                    break;
                }
                case 2: { /** state BEWEGUNG in chart BLOCK_ERKENNUNG_CTRL **/
                    if ((!(statemate_FH_TUERMODUL__MFHA) && statemate_FH_TUERMODUL__MFHA_old) ||
                    ...
                    switch (statemate_BEWEGUNG_BLOCK_ERKENNUNG_CTRL_next_state) {
                        ...
                        case 2: { /** state FENSTER_BEWEGT_SICH in chart BLOCK_ERKENNUNG_CTRL **/
                            if ((statemate_FH_TUERMODUL__I_EIN > (statemate_BLOCK_ERKENNUNG_CTRL__I_EIN_MAX - 2))) {
                                statemate_stable = 0;
                        ...
                        case 3: { /** state EINSCHALTSTROM_MESSEN in chart BLOCK_ERKENNUNG_CTRL **/
                            ...
                            if (statemate_BEWEGUNG_BLOCK_ERKENNUNG_CTRL_next_state == 3) {
                                if (statemate_step == 1 &&
                                    ...
                                    if ((statemate_FH_TUERMODUL__I_EIN > statemate_BLOCK_ERKENNUNG_CTRL__I_EIN_MAX))
    ...
    void statemate_FH_DU(void) {
        ...
        for (i = 0; i < 100; i++) {
            ...
            {
                {
                    ...
                    if (statemate_FH_DU__S_FH_TMBFZUCAN != statemate_FH_DU__S_FH_TMBFZUCAN_old) {
                        if ((!statemate_FH_DU__DOOR_ID)) statemate_FH_DU__S_FH_FTZU = statemate_FH_DU__S_FH_TMBFZUCAN;
                    }
                    if (statemate_FH_DU__S_FH_TMBFZUDISC != statemate_FH_DU__S_FH_TMBFZUDISC_old) {
                        if (statemate_FH_DU__DOOR_ID)
                            statemate_FH_DU__S_FH_TMBFZUCAN = statemate_FH_DU__S_FH_TMBFZUDISC;
                    }
                    if (statemate_FH_DU__S_FH_TMBFAUFCAN != statemate_FH_DU__S_FH_TMBFAUFCAN_old) {
                        if ((!statemate_FH_DU__DOOR_ID)) statemate_FH_DU__S_FH_FTAUF = statemate_FH_DU__S_FH_TMBFAUFCAN;
                    }
                    if (statemate_FH_DU__S_FH_TMBFAUFDISC != statemate_FH_DU__S_FH_TMBFAUFDISC_old) {
                        if (statemate_FH_DU__DOOR_ID)
            ...
            statemate_FH_TUERMODUL__EKS_LEISTE_AKTIV_old = statemate_FH_TUERMODUL__EKS_LEISTE_AKTIV;
   ...
   private:
    char statemate_bitlist[64];
    unsigned long statemate_tm_entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRLch_BLOCK_ERKENNUNG_CTRL__N_copy;
    unsigned long statemate_tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRLexited_BEREIT_FH_TUERMODUL_CTRL;
    ...
    char statemate_NICHT_INITIALISIERT_NICHT_INITIALISIERT_next_state;   /** 2 bits **/
    ...
    char statemate_EINKLEMMSCHUTZ_CTRL_EINKLEMMSCHUTZ_CTRL_next_state;   /** 2 bits **/
