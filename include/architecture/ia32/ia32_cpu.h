...
public:
    ...
    public:
        Context() {}
        Context(Log_Addr usp, Log_Addr entry): _esp3(usp), _eip(entry), _cs(((Traits<Build>::SMOD == Traits<Build>::KERNEL) && usp)? SEL_APP_CODE : SEL_SYS_CODE), _eflags(FLAG_DEFAULTS) {
...
public:
    ...
    static Reg64 rdtsc() { Reg64 r; ASM("rdtsc" : "=A"(r) : ); return r; }
