...
protected:
    Timer(Channel channel, Hertz frequency, Handler handler, bool retrigger = true)
...
public:
    User_Timer(Channel channel, Microsecond time, Handler handler, bool periodic = false)
