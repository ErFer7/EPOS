...
public:
    ...
    void disable() {
        ...
        irq(DISABLE_IRQS_1) = ~1;
        irq(DISABLE_IRQS_2) = ~1;
    }
    ...
    Interrupt_Id int_id() {
        ...
        if(pending) {
            ...
            if(pending & 8)     return SYSTEM_TIMER_MATCH3; // handler needs to reset counter compare register
...
public:
    ...
    void eoi(Interrupt_Id int_id = 0) {
