// EPOS Xilinx Ultrascale+ ZU3EG - FZ3 - (Cortex-A53) Metainfo and Configuration

#ifndef __fz3_traits_h
#define __fz3_traits_h
...
public:
    ...
    static const unsigned int RAM_TOP           = 0x7dffffff;   // 2 GB - 32 M
    ...
    static const unsigned int RESET             = (emulated && armv7) ? 0x00010000 : 0x00200000;
    ...
    static const unsigned int APP_DATA          = APP_CODE + (armv7 ? 4 : 16) * 1024 * 1024;
