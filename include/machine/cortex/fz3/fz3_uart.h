// EPOS Xilinx Ultrascale+ ZU3EG - FZ3 - (ARM Cortex-A53) UART Mediator Declarations
...
#include <machine/cortex/engine/cortex_a53/ultrascale_uart.h>
...
public:
    ...
    : _unit(unit), _uart(new(reinterpret_cast<void *>(0xff000000)) Xilinx_UART) {
        // assert(unit < UNITS);
