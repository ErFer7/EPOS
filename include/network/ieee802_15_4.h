...
public:
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Phy_Frame & f) {
            os << "{d=" << f._data << "}";
            return os;
        }
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Frame_Control & fc) {
            os << "{type=" << fc.type() << ",se=" << fc.se() << ",fp=" << fc.fp() << ",ar=" << fc.ar() << ",pic=" << fc.pic() << ",dam=" << fc.dam() << ",fv=" << fc.fv() << ",sam=" << fc.sam() << "}";
            return os;
        }
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Raw_Header & h) {
            os << "{" << "fc=" << h._fc << ",id=" << h._id << "}";
            return os;
        }
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Raw_Frame & f) {
            os << "{d=" << f._data << ",c=" << f._crc << "}";
            return os;
        }
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Log_Header & h) {
            os << "{" << "fc=" << h._frame_control << ",sn=" << h._sequence_number << ",pid=" << h._dst_pan_id << ",dst=" << h._dst << ",src=" << h._src << "," << "}";
            return os;
        }
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Log_Frame & f) {
            os << "{h=" << reinterpret_cast<const Log_Header &>(f) << ",d=" << f._data << ",c=" << f._crc << "}";
            return os;
        }
