...
public:
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Peer & p) {
            os << "{id=" << p._id << ",au=" << p._auth << ",v=" << p._valid << ",ms=" << p._master_secret << ",el=" << &p._el << "}";
            return os;
        }
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Pending_Key & p) {
            os << "{msc=" << p._master_secret_calculated << ",c=" << p._creation << ",pk=" << p._public_key << ",ms=" << p._master_secret << ",el=" << &p._el << "}";
            return os;
        }
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const DH_Request & m) {
            os << reinterpret_cast<const Control &>(m) << ",d=" << m._destination << ",k=" << m._public_key;
            return os;
        }
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const DH_Response & m) {
            os << reinterpret_cast<const Control &>(m) << ",k=" << m._public_key;
            return os;
        }
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Auth_Request & m) {
            os << reinterpret_cast<const Control &>(m) << ",a=" << m._auth << ",o=" << m._otp;
            return os;
        }
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Auth_Granted & m) {
            os << reinterpret_cast<const Control &>(m) << ",d=" << m._destination << ",a=" << m._auth;
            return os;
        }
