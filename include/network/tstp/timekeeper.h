...
public:
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Epoch & e) {
            os << reinterpret_cast<const Control &>(e) << ",d=" << e.destination() << ",e=" << e._reference << ",c=" << e._coordinates;
            return os;
        }
    ...
    public:
        ...
        friend OStream & operator<<(OStream & os, const Keep_Alive & k) {
            os << reinterpret_cast<const Control &>(k);
            return os;
        }
    } __attribute__((packed));
