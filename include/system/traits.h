...
enum System_Event {
    ...
    RUNNING_THREAD,
    JOB_UTILIZATION,
    JOB_UTILIZATION_PER_PERIOD,
    CORE,
    PREDICTED_JOB_UTILIZATION,

    // FIX: These should be transducers
    CPU_CLOCK,
    CPU_VOLTAGE,
};
...
enum PMU_Event {
    ...
    BUS_CYCLES,
    BUS_ACCESSES,
    TLB_MISSES,                                     DATA_TLB_MISSES = TLB_MISSES,                   MMU_MISSES = TLB_MISSES,
...
#endif
#if defined(__ia32__) || defined(__riscv__) || defined(__cortex_a9__)
...
#endif
#if defined(__ia32__) || defined(__riscv__)
