...
public: // Create and Run and Online Train
    static struct fann* fann_create_from_config(float train_error_threshold = 0) {
        ...
        const unsigned int layers_sizes[] = { 13, 3, 4, 2 }; // each layer has a bias neuron
        ...
        const float neurons_config[][3] = {
            ...
            {0, 0, 0.00000000000000000000e+00},
            {0, 0, 0.00000000000000000000e+00},
            {13, 4, 5.00000000000000000000e-01},
            {13, 4, 5.00000000000000000000e-01},
            {0, 4, 0.00000000000000000000e+00},
            {3, 4, 5.00000000000000000000e-01},
            {3, 4, 5.00000000000000000000e-01},
            {3, 4, 5.00000000000000000000e-01},
            {0, 4, 0.00000000000000000000e+00},
        ...
        const float weights_config[][3] = {
            {0, -8.30884754657745361328e-01},
            {1, 1.67289125919342041016e+00},
            {2, -3.34010004997253417969e-01},
            {3, 4.09968048334121704102e-01},
            {4, 1.17911815643310546875e+00},
            {5, -1.44239783287048339844e+00},
            {6, 4.43310469388961791992e-01},
            {7, 2.19957381486892700195e-01},
            {8, 4.90609183907508850098e-02},
            {9, -1.07303762435913085938e+00},
            {10, -3.56247909367084503174e-02},
            {11, -2.38929405808448791504e-01},
            {12, 1.35752901434898376465e-01},
            {0, -3.75884532928466796875e-01},
            {1, 3.05741786956787109375e-01},
            {2, -5.14879882335662841797e-01},
            {3, -3.54730308055877685547e-01},
            {4, 1.43186962604522705078e+00},
            {5, -4.01998609304428100586e-01},
            {6, 3.08956950902938842773e-01},
            {7, 5.52472770214080810547e-01},
            {8, 5.42207717895507812500e-01},
            {9, -2.78020530939102172852e-01},
            {10, -1.49989100173115730286e-02},
            {11, 2.28211537003517150879e-01},
            {12, 1.28210023045539855957e-01},
            {13, -1.05871737003326416016e+00},
            {14, -8.88021171092987060547e-01},
            {15, 3.27483177185058593750e-01},
            {13, -1.90194904804229736328e+00},
            {14, -1.00046813488006591797e+00},
            {15, 8.03304851055145263672e-01},
            {13, -1.43948554992675781250e+00},
            {14, -9.01871800422668457031e-01},
            {15, 3.82677704095840454102e-01},
            {16, 1.36235046386718750000e+00},
            {17, 2.26630401611328125000e+00},
            {18, 1.55726909637451171875e+00},
            {19, -5.27974367141723632812e-01}
        };
