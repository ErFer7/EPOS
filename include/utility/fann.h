...
public:
    ...
    static constexpr float    LEARNING_RATE_CONFIG        = 0.010000;
...
public: // Create and Run and Online Train
    static struct fann* fann_create_from_config(float train_error_threshold = 0) {
        ...
        const unsigned int layers_sizes[] = { 12, 4, 4, 2 }; // each layer has a bias neuron
        ...
        const float neurons_config[][3] = {
            ...
            {0, 0, 0.00000000000000000000e+00},
            {0, 0, 0.00000000000000000000e+00},
            {12, 6, 5.00000000000000000000e-01},
            {12, 6, 5.00000000000000000000e-01},
            {12, 6, 5.00000000000000000000e-01},
        ...
        const float weights_config[][3] = {
            {0, -3.70262295007705688477e-01},
            {1, 9.01820600032806396484e-01},
            {2, -3.94691199064254760742e-01},
            {3, -1.14465653896331787109e-01},
            {4, -6.70919775962829589844e-01},
            {5, 7.37305879592895507812e-02},
            {6, 4.27420198917388916016e-01},
            {7, 7.47068077325820922852e-02},
            {8, 3.35185490548610687256e-02},
            {9, -2.30901967734098434448e-02},
            {10, 3.18655446171760559082e-02},
            {11, 4.15702402591705322266e-01},
            {0, -2.97173224389553070068e-02},
            {1, 4.49648424983024597168e-02},
            {2, 2.00604908168315887451e-02},
            {3, -1.13484315574169158936e-01},
            {4, -8.67513790726661682129e-02},
            {5, -2.39122081547975540161e-02},
            {6, 9.10430774092674255371e-02},
            {7, 1.68046392500400543213e-02},
            {8, -5.13636507093906402588e-02},
            {9, 1.92105304449796676636e-02},
            {10, 9.12965908646583557129e-02},
            {11, 4.86768297851085662842e-02},
            {0, -2.90242820978164672852e-01},
            {1, 4.25270229578018188477e-01},
            {2, -3.43773007392883300781e-01},
            {3, -2.77760416269302368164e-01},
            {4, -4.25114423036575317383e-01},
            {5, 1.19718695059418678284e-02},
            {6, 2.43454739451408386230e-01},
            {7, -7.98428356647491455078e-02},
            {8, -4.48587387800216674805e-02},
            {9, -3.60808940604329109192e-03},
            {10, -3.15862819552421569824e-02},
            {11, 9.96754840016365051270e-02},
            {12, 8.09815466403961181641e-01},
            {13, 1.76821928471326828003e-02},
            {14, 5.82312464714050292969e-01},
            {15, 8.56780856847763061523e-02},
            {12, 7.33578860759735107422e-01},
            {13, 1.25956401228904724121e-01},
            {14, 5.72166621685028076172e-01},
            {15, -5.34220738336443901062e-03},
            {12, -1.88636079430580139160e-01},
            {13, 4.68744970858097076416e-02},
            {14, -1.54777482151985168457e-01},
            {15, 2.41829380393028259277e-02},
            {16, -8.72755050659179687500e-01},
            {17, -8.56672048568725585938e-01},
            {18, 2.13229328393936157227e-01},
            {19, 9.79514896869659423828e-01}
        };
