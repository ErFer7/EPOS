...
// Atomic heap
class Atomic_Heap: public Heap
{
public:
    Atomic_Heap() {}
    Atomic_Heap(void * addr, unsigned int bytes): Heap(addr, bytes) {}
...
typedef IF<Traits<System>::multicore, Atomic_Heap, Heap>::Result Application_Heap;
