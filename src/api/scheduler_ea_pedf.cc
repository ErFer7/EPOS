...
//
//    _bus_access_st_ca53_v8[cpu] = new (SYSTEM) Clerk<PMU>(PMU_Event::BUS_ACCESSES, 0, false);
//    _data_write_stall_st_buffer_full_ca53_v8[cpu] = new (SYSTEM) Clerk<PMU>(PMU_Event::STALL_CYCLES_MEMORY, 0, false);
//    _immediate_branches_ca[cpu] = new (SYSTEM) Clerk<PMU>(PMU_Event::IMMEDIATE_BRANCHES, 0, false);
//    _l2d_writeback[cpu] = new (SYSTEM) Clerk<PMU>(PMU_Event::L2_DATA_CACHE_WRITEBACKS, 0, false);
//    _cpu_cycles[cpu] = new (SYSTEM) Clerk<PMU>(PMU_Event::CPU_CYCLES, 0, false);
//    _l1_cache_hits[cpu] = new (SYSTEM) Clerk<PMU>(PMU_Event::L1_CACHE_HITS, 0, false);
//}
//
