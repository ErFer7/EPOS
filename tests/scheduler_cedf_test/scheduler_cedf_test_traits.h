...
template<> struct Traits<Build>: public Traits_Tokens
{
    ...
    static const unsigned int CPUS = ((MODEL == Legacy_PC) || (MODEL == Raspberry_Pi3) || (MODEL == Realview_PBX) || (MODEL == Zynq)) ? 8 : (MODEL == SiFive_U) ?  2 : 1;
...
template<> struct Traits<System>: public Traits<Build>
{
    ...
    static const bool multitask = (SMOD != LIBRARY);
...
template<> struct Traits<Thread>: public Traits<Build>
{
    ...
    typedef IF<(CPUS > 1), CEDF, EDF>::Result Criterion;
